...
----------------------------------------*/
class leopet_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('leopet_instagram_photo',esc_html__('[ Leopet ] Intagram Photo','leopet-companion'),array(
			'description' => esc_html__('Leopet Instagram Photo Widget','leopet-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'leopet-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'leopet-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'leopet-companion'); ?></label>
...
if(!function_exists('leopet_instagram_widgets')):
	function leopet_instagram_widgets(){
		register_widget('leopet_instagram_photo');
	}
	add_action('widgets_init','leopet_instagram_widgets');
endif;
