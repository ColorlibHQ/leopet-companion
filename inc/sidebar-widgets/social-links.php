...
class Leopet_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Leopet ] Social Links', 'leopet-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'leopet-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'leopet-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'leopet-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'leopet-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'leopet-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'leopet-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'leopet-companion'); ?></label>
...
} // Class leopet_social_links ends here


// Register and load the widget
function leopet_social_links_widget_load() {
	register_widget( 'Leopet_social_links' );
}
add_action( 'widgets_init', 'leopet_social_links_widget_load' );